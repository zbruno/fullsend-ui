...
type ButtonElementProps = Pick<ButtonProps, 'buttonStyle' | 'disabled' | 'loading'>;
...
export const ButtonElement = styled.button(({ buttonStyle, disabled, loading }: ButtonElementProps) => [
  ...
  disabled && tw`cursor-not-allowed bg-gray-300 text-gray-500 pointer-events-none`,
  loading && css`
